  ...
  return (
    <div className="w-full bg-[#faf9f6] text-stone-850">
      ...
      <section 
        ...
        style={{
          backgroundImage: `linear-gradient(135deg, rgba(12, 10, 9, 0.93) 0%, rgba(28, 25, 23, 0.88) 45%, rgba(12, 10, 9, 0.85) 100%), url('https://images.unsplash.com/photo-1560250097-0b93528c311a?auto=format&fit=crop&w=2000&q=85')`,
        }}
      >
